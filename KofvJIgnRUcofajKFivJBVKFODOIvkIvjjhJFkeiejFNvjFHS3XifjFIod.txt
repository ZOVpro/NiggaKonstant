...
local function v4346(v1127, v1128) --[[ Line: 3102 ]] --[[ Name: decompile_bytecode ]]
	...
	if string.byte(v1127, 1, 1) == 0 then
		local v1138 = string.format("-- Successfully decompiled with NiggaKernel\n-- Decompiler made by plusgiant5 (Konstant), https://discord.gg/tm5t4Zm3: %s", "2.1")
		...
		for _, v3927 in pairs(table.clone(v1208)) do
			...
			local v3943 = ("-- Successfully decompiled with NiggaKernel\n-- Decompiler made by plusgiant5 (Konstant), https://discord.gg/tm5t4Zm3\n"):format("2.1");
			if type(v1127) ~= "string" and l_getscripthash_0 then
